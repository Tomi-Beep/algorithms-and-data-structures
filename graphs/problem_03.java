...
class AdjacencyListGraph<T> {
    ...
    public void findPath(T startVertex, T endVertex) {
        ...
        java.util.Stack<T> path = new java.util.Stack<>();
    ...
    public int brojach(T pochetok, int zbir) {
        if (zbir - (Integer) pochetok == 0) {
            return 1;
        }
        if (zbir - (Integer) pochetok < 0) {
            return 0;
        ...
        for (T neighbor : getNeighbors(pochetok)) {
            counter += brojach(neighbor, zbir - (Integer) pochetok);
        }
