...
public class chillinnn {
    ...
    public static void main(String[] args) {
        ...
        int counter = 0;
        DLLNode<Integer> t = lista.getFirst().succ;
        while (t != null && t.pred != null && t.succ != null) {
            DLLNode<Integer> l = t.pred;
            DLLNode<Integer> r = t.succ;
            int zbir1 = l.element;
            int zbir2 = r.element;
            int counter1 = 1;
            int counter2 = 1;
            while (l != null && l.pred != null) {
                l = l.pred;
                zbir1 += l.element;
                counter1++;
            }
            while (r != null && r.succ != null) {
                r = r.succ;
                zbir2 += r.element;
                counter2++;
            }
            if ((float) zbir1 / counter1 > (float) zbir2 / counter2)
                counter++;
            t = t.succ;
        }
